...
namespace Ideogram
{
    ...
    {
        /// <summary>
        /// Generate with the distilled few-step Ideogram model (high speed tier)<br/>
        /// Generates images synchronously using the distilled few-step Ideogram<br/>
        /// model at the high speed tier — the highest quality, at the highest cost.<br/>
        ...
        global::System.Threading.Tasks.Task<global::Ideogram.ImageGenerationResponseV4> PostGenerateImagePImageHighAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.ImageGenerationResponseV4>> PostGenerateImagePImageHighAsResponseAsync(
