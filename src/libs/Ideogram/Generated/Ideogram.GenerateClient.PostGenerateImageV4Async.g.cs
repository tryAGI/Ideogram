...
namespace Ideogram
{
    public partial class GenerateClient
    {
        ...
        /// <summary>
        /// Generate with Ideogram 4.0 asynchronously<br/>
        /// Accepts an Ideogram 4.0 generation request for asynchronous processing and<br/>
        /// returns immediately with a generation_id. Poll `GET /v1/generations/{generation_id}`<br/>
        /// to retrieve the result. If a `webhook_url` is supplied, the generated images are<br/>
        /// additionally POSTed to it once ready, in a payload that mirrors the synchronous<br/>
        /// response with an added generation_id for correlation.<br/>
