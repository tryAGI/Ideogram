...
namespace Ideogram
{
    public partial class MiniAppsClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PublishPreviewMiniAppSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PublishPreviewMiniAppSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PublishPreviewMiniAppSecurityRequirement0,
            };
        partial void PreparePublishPreviewMiniAppArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.PublishMiniAppPreviewRequest request);
        partial void PreparePublishPreviewMiniAppRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.PublishMiniAppPreviewRequest request);
        partial void ProcessPublishPreviewMiniAppResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPublishPreviewMiniAppResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.PublishMiniAppPreviewResponse> PublishPreviewMiniAppAsync(

            global::Ideogram.PublishMiniAppPreviewRequest request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PublishPreviewMiniAppAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.PublishMiniAppPreviewResponse>> PublishPreviewMiniAppAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePublishPreviewMiniAppArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PublishPreviewMiniAppSecurityRequirements,
                operationName: "PublishPreviewMiniAppAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePublishPreviewMiniAppRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PublishPreviewMiniApp",
                                methodName: "PublishPreviewMiniAppAsync",
                                pathTemplate: "\"/mini-apps/publish-preview\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPublishPreviewMiniAppResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPublishPreviewMiniAppResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.PublishMiniAppPreviewResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.PublishMiniAppPreviewResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.PublishMiniAppPreviewResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.PublishMiniAppPreviewResponse> PublishPreviewMiniAppAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.PublishMiniAppPreviewRequest
            {
                PreviewId = previewId,
                Slug = slug,
                Label = label,
            ...
            return await PublishPreviewMiniAppAsync(
                request: __request,
                requestOptions: requestOptions,
