...
namespace Ideogram
{
    public partial class ImagesEditClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostEditImageGemini30ProSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostEditImageGemini30ProSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostEditImageGemini30ProSecurityRequirement0,
            };
        partial void PreparePostEditImageGemini30ProArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.EditImageGemini30ProRequest request);
        partial void PreparePostEditImageGemini30ProRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.EditImageGemini30ProRequest request);
        partial void ProcessPostEditImageGemini30ProResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostEditImageGemini30ProResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.EditImageGemini30ProResponse> PostEditImageGemini30ProAsync(

            global::Ideogram.EditImageGemini30ProRequest request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostEditImageGemini30ProAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.EditImageGemini30ProResponse>> PostEditImageGemini30ProAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostEditImageGemini30ProArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostEditImageGemini30ProSecurityRequirements,
                operationName: "PostEditImageGemini30ProAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Ideogram.PathBuilder(
                                path: "/v2/images/edit/gemini-3.0-pro",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostEditImageGemini30ProRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostEditImageGemini30Pro",
                                methodName: "PostEditImageGemini30ProAsync",
                                pathTemplate: "\"/v2/images/edit/gemini-3.0-pro\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostEditImageGemini30ProResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostEditImageGemini30ProResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.EditImageGemini30ProResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.EditImageGemini30ProResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.EditImageGemini30ProResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.EditImageGemini30ProResponse> PostEditImageGemini30ProAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.EditImageGemini30ProRequest
            {
                Prompt = prompt,
            ...
            return await PostEditImageGemini30ProAsync(
                request: __request,
                requestOptions: requestOptions,
