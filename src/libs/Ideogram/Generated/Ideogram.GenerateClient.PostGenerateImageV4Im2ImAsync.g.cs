...
namespace Ideogram
{
    public partial class GenerateClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostGenerateImageV4Im2ImAsyncSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostGenerateImageV4Im2ImAsyncSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostGenerateImageV4Im2ImAsyncSecurityRequirement0,
            };
        partial void PreparePostGenerateImageV4Im2ImAsyncArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string webhookUrl,
            global::Ideogram.GenerateImageRequestV4Im2Im request);
        partial void PreparePostGenerateImageV4Im2ImAsyncRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string webhookUrl,
            global::Ideogram.GenerateImageRequestV4Im2Im request);
        partial void ProcessPostGenerateImageV4Im2ImAsyncResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostGenerateImageV4Im2ImAsyncResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.AsyncImageGenerationResponseV4> PostGenerateImageV4Im2ImAsyncAsync(
            string webhookUrl,
        ...
        {
            var __response = await PostGenerateImageV4Im2ImAsyncAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.AsyncImageGenerationResponseV4>> PostGenerateImageV4Im2ImAsyncAsResponseAsync(
            string webhookUrl,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostGenerateImageV4Im2ImAsyncArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostGenerateImageV4Im2ImAsyncSecurityRequirements,
                operationName: "PostGenerateImageV4Im2ImAsyncAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Ideogram.PathBuilder(
                                path: "/v1/ideogram-v4/async/image-to-image",
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.AdditionalImages != default)
                            {
                                ...
                                for (var __iAdditionalImages = 0; __iAdditionalImages < request.AdditionalImages.Count; __iAdditionalImages++)
                                {
                                    var __contentAdditionalImages = new global::System.Net.Http.ByteArrayContent(request.AdditionalImages[__iAdditionalImages]);
                                __contentAdditionalImages.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue("application/octet-stream");
                                    __httpRequestContent.Add(
                                        content: __contentAdditionalImages,
                                        name: "\"additional_images\"",
                                        fileName: $"\"file{__iAdditionalImages}.bin\"");
                                    if (__contentAdditionalImages.Headers.ContentDisposition != null)
                                    {
                                        __contentAdditionalImages.Headers.ContentDisposition.FileNameStar = null;
                                    }
                                }
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostGenerateImageV4Im2ImAsyncRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostGenerateImageV4Im2ImAsync",
                                methodName: "PostGenerateImageV4Im2ImAsyncAsync",
                                pathTemplate: "\"/v1/ideogram-v4/async/image-to-image\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostGenerateImageV4Im2ImAsyncResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PostGenerateImageV4Im2ImAsyncAsync(
                webhookUrl: webhookUrl,
                request: __request,
                requestOptions: requestOptions,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Ideogram.GenerateImageRequestV4Im2Im
            {
                ...
                Imagename = imagename,
                AdditionalImages = new global::System.Collections.Generic.List<byte[]>(),
                Prompt = prompt,
                Seed = seed,
                MagicPromptOption = magicPromptOption,
                MagicPromptSystemPromptConfigId = magicPromptSystemPromptConfigId,
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (additionalImages != default)
                            {

                                for (var __iAdditionalImages = 0; __iAdditionalImages < additionalImages.Count; __iAdditionalImages++)
                                {
                                    var __fileNameAdditionalImages = additionalImagesFileNames != null &&
                                        __iAdditionalImages < additionalImagesFileNames.Count &&
                                        additionalImagesFileNames[__iAdditionalImages] != null
                                        ? additionalImagesFileNames[__iAdditionalImages]
                                        : $"file{__iAdditionalImages}.bin";
                                    var __contentAdditionalImages = new global::System.Net.Http.StreamContent(additionalImages[__iAdditionalImages]);
                                __contentAdditionalImages.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    __fileNameAdditionalImages is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(__fileNameAdditionalImages) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                                    ...
                                    __httpRequestContent.Add(
                                        content: __contentAdditionalImages,
                                        name: "\"additional_images\"",
                                        fileName: $"\"{__fileNameAdditionalImages}\"");
                                    if (__contentAdditionalImages.Headers.ContentDisposition != null)
                                    {
                                        __contentAdditionalImages.Headers.ContentDisposition.FileNameStar = null;
                                    }
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Ideogram.AsyncImageGenerationResponseV4.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Ideogram.AsyncImageGenerationResponseV4.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
