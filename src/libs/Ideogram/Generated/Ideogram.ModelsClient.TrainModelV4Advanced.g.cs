...
namespace Ideogram
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_TrainModelV4AdvancedSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_TrainModelV4AdvancedSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_TrainModelV4AdvancedSecurityRequirement0,
            };
        partial void PrepareTrainModelV4AdvancedArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.TrainModelV4AdvancedRequest request);
        partial void PrepareTrainModelV4AdvancedRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.TrainModelV4AdvancedRequest request);
        partial void ProcessTrainModelV4AdvancedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTrainModelV4AdvancedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Train a custom Ideogram v4 model with advanced hyperparameters<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.TrainDatasetModelResponse> TrainModelV4AdvancedAsync(

            global::Ideogram.TrainModelV4AdvancedRequest request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await TrainModelV4AdvancedAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.TrainDatasetModelResponse>> TrainModelV4AdvancedAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTrainModelV4AdvancedArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TrainModelV4AdvancedSecurityRequirements,
                operationName: "TrainModelV4AdvancedAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTrainModelV4AdvancedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TrainModelV4Advanced",
                                methodName: "TrainModelV4AdvancedAsync",
                                pathTemplate: "\"/v1/ideogram-v4/train-model-advanced\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTrainModelV4AdvancedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTrainModelV4AdvancedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.TrainDatasetModelResponse>(
                                        statusCode: __response.StatusCode,
        ...
        /// Per-step training batch size. Must be one of 1, 2, 4, 8, 16, or 32. Defaults to a trainer-side value when omitted. Larger batches can improve throughput at the cost of more memory.<br/>
        /// Example: 8
        /// </param>
        /// <param name="wandbProject">
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.TrainDatasetModelResponse> TrainModelV4AdvancedAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.TrainModelV4AdvancedRequest
            {
                DatasetId = datasetId,
                ModelName = modelName,
            ...
            return await TrainModelV4AdvancedAsync(
                request: __request,
                requestOptions: requestOptions,
