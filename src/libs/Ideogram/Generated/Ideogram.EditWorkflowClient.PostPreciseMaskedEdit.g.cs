...
namespace Ideogram
{
    public partial class EditWorkflowClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostPreciseMaskedEditSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostPreciseMaskedEditSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostPreciseMaskedEditSecurityRequirement0,
            };
        partial void PreparePostPreciseMaskedEditArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.PreciseMaskedEditRequest request);
        partial void PreparePostPreciseMaskedEditRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.PreciseMaskedEditRequest request);
        partial void ProcessPostPreciseMaskedEditResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostPreciseMaskedEditResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.PreciseMaskedEditResponse> PostPreciseMaskedEditAsync(

            global::Ideogram.PreciseMaskedEditRequest request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostPreciseMaskedEditAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.PreciseMaskedEditResponse>> PostPreciseMaskedEditAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostPreciseMaskedEditArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostPreciseMaskedEditSecurityRequirements,
                operationName: "PostPreciseMaskedEditAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.SourceAssetIdentifier != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.SourceAssetIdentifier.ToJson(JsonSerializerContext)),
                                    name: "\"source_asset_identifier\"");

                            }
                            if (request.SourceImage != default)
                            {

                                var __contentSourceImage = new global::System.Net.Http.ByteArrayContent(request.SourceImage ?? global::System.Array.Empty<byte>());
                                __contentSourceImage.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.SourceImagename is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.SourceImagename) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                                ...
                                __httpRequestContent.Add(
                                    content: __contentSourceImage,
                                    name: "\"source_image\"",
                                    fileName: request.SourceImagename != null ? $"\"{request.SourceImagename}\"" : string.Empty);
                                if (__contentSourceImage.Headers.ContentDisposition != null)
                                {
                                    __contentSourceImage.Headers.ContentDisposition.FileNameStar = null;
                                }

                            }
                            if (request.MaskAssetIdentifier != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.MaskAssetIdentifier.ToJson(JsonSerializerContext)),
                                    name: "\"mask_asset_identifier\"");

                            }
                            if (request.ReferenceAssetIdentifiers != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent($"[{string.Join(",", global::System.Linq.Enumerable.Select(request.ReferenceAssetIdentifiers!, x => x.ToJson(JsonSerializerContext)))}]"),
                                    name: "\"reference_asset_identifiers\"");
                            ...
                            if (request.PreserveUnmaskedPixels != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((global::System.Convert.ToString(request.PreserveUnmaskedPixels, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty).ToLowerInvariant()),
                                    name: "\"preserve_unmasked_pixels\"");
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostPreciseMaskedEditRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostPreciseMaskedEdit",
                                methodName: "PostPreciseMaskedEditAsync",
                                pathTemplate: "\"/v2/workflow/precise-masked-edit\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostPreciseMaskedEditResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostPreciseMaskedEditResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.PreciseMaskedEditResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.PreciseMaskedEditResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.PreciseMaskedEditResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.PreciseMaskedEditResponse> PostPreciseMaskedEditAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.PreciseMaskedEditRequest
            {
                Model = model,
                Quality = quality,
                ...
                MaskAssetIdentifier = maskAssetIdentifier,
                ReferenceAssetIdentifiers = referenceAssetIdentifiers,
            ...
            return await PostPreciseMaskedEditAsync(
                request: __request,
                requestOptions: requestOptions,
