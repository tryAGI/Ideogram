...
namespace Ideogram
{
    public partial class EditWorkflowClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostSkechersStyleEditSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostSkechersStyleEditSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostSkechersStyleEditSecurityRequirement0,
            };
        partial void PreparePostSkechersStyleEditArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.SkechersStyleEditRequest request);
        partial void PreparePostSkechersStyleEditRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.SkechersStyleEditRequest request);
        partial void ProcessPostSkechersStyleEditResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostSkechersStyleEditResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.SkechersStyleEditResponse> PostSkechersStyleEditAsync(

            global::Ideogram.SkechersStyleEditRequest request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostSkechersStyleEditAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.SkechersStyleEditResponse>> PostSkechersStyleEditAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostSkechersStyleEditArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostSkechersStyleEditSecurityRequirements,
                operationName: "PostSkechersStyleEditAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostSkechersStyleEditRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostSkechersStyleEdit",
                                methodName: "PostSkechersStyleEditAsync",
                                pathTemplate: "\"/v2/tool/skechers-style-editor\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostSkechersStyleEditResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostSkechersStyleEditResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.SkechersStyleEditResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.SkechersStyleEditResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.SkechersStyleEditResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.SkechersStyleEditResponse> PostSkechersStyleEditAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.SkechersStyleEditRequest
            {
                BaseAssetIdentifier = baseAssetIdentifier,
            ...
            return await PostSkechersStyleEditAsync(
                request: __request,
                requestOptions: requestOptions,
