...
namespace Ideogram
{
    ...
    public sealed partial class ImageGenerationObjectV4ImageToImage
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Ideogram.ResolutionV4ImageToImage Resolution { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageGenerationObjectV4ImageToImage" /> class.
        /// </summary>
        /// <param name="prompt">
        /// The prompt used for the generation. This may be different from the original prompt.
        /// </param>
