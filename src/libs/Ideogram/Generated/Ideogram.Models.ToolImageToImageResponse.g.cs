...
{
    /// <summary>
    /// Response returned by `POST /v2/tool/image-to-image`. Synchronous<br/>
    /// requests (the default) include the transformed images in `data`.<br/>
    ...
    public sealed partial class ToolImageToImageResponse
    {
        ...
        /// <summary>
        /// The transformed images, in generation order. Present only for synchronous requests (`async` omitted or false).
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolImageToImageResponse" /> class.
        /// </summary>
...
#endif
        public ToolImageToImageResponse(
            string generationId,
            int seed,
