    ...
    public partial class EditWorkflowClient
    {
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.MaterialAssetIdentifier != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.MaterialAssetIdentifier.ToJson(JsonSerializerContext)),
                                    name: "\"material_asset_identifier\"");

                            }
                            if (request.Material != default)
                            {

                                var __contentMaterial = new global::System.Net.Http.ByteArrayContent(request.Material ?? global::System.Array.Empty<byte>());
                                __contentMaterial.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.Materialname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.Materialname) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                                ...
                                __httpRequestContent.Add(
                                    content: __contentMaterial,
                                    name: "\"material\"",
                                    fileName: request.Materialname != null ? $"\"{request.Materialname}\"" : string.Empty);
                                if (__contentMaterial.Headers.ContentDisposition != null)
                                {
                                    __contentMaterial.Headers.ContentDisposition.FileNameStar = null;
                                }
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.MaterialSwapRequest
            {
                ...
                Mask = mask,
                Maskname = maskname,
                MaterialAssetIdentifier = materialAssetIdentifier,
                Material = material,
