...
{
    /// <summary>
    /// Response returned by `POST /v2/images/edit/gemini-3.1-flash`. Synchronous<br/>
    ...
    public sealed partial class EditImageGemini31FlashResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EditImageGemini31FlashResponse" /> class.
        /// </summary>
...
#endif
        public EditImageGemini31FlashResponse(
            string generationId,
            int seed,
            int width,
            int height,
