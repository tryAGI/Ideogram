...
namespace Ideogram
{
    public partial class ImagesGenerateClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostGenerateImageV2Gemini31FlashSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostGenerateImageV2Gemini31FlashSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostGenerateImageV2Gemini31FlashSecurityRequirement0,
            };
        partial void PreparePostGenerateImageV2Gemini31FlashArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? dryRun,
            global::Ideogram.GenerateImageGemini31FlashRequest request);
        partial void PreparePostGenerateImageV2Gemini31FlashRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? dryRun,
            global::Ideogram.GenerateImageGemini31FlashRequest request);
        partial void ProcessPostGenerateImageV2Gemini31FlashResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostGenerateImageV2Gemini31FlashResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Generate images with Gemini 3.1 Flash, from a text prompt or by editing source images<br/>
        /// Generate one or more images with Gemini 3.1 Flash. The prompt is<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.GenerateImageGemini31FlashResponse> PostGenerateImageV2Gemini31FlashAsync(
        ...
        {
            var __response = await PostGenerateImageV2Gemini31FlashAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.GenerateImageGemini31FlashResponse>> PostGenerateImageV2Gemini31FlashAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostGenerateImageV2Gemini31FlashArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostGenerateImageV2Gemini31FlashSecurityRequirements,
                operationName: "PostGenerateImageV2Gemini31FlashAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Ideogram.PathBuilder(
                                path: "/v2/image/generate/gemini-3.1-flash",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostGenerateImageV2Gemini31FlashRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostGenerateImageV2Gemini31Flash",
                                methodName: "PostGenerateImageV2Gemini31FlashAsync",
                                pathTemplate: "\"/v2/image/generate/gemini-3.1-flash\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostGenerateImageV2Gemini31FlashResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostGenerateImageV2Gemini31FlashResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.GenerateImageGemini31FlashResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.GenerateImageGemini31FlashResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.GenerateImageGemini31FlashResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.GenerateImageGemini31FlashResponse> PostGenerateImageV2Gemini31FlashAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.GenerateImageGemini31FlashRequest
            {
                Prompt = prompt,
            ...
            return await PostGenerateImageV2Gemini31FlashAsync(
                dryRun: dryRun,
                request: __request,
                requestOptions: requestOptions,
