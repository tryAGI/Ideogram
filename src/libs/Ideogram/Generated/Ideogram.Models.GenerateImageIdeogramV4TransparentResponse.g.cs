...
namespace Ideogram
{
    ...
    /// `POST /v2/image/generate/ideogram-4-transparent`. Synchronous<br/>
    ...
    public sealed partial class GenerateImageIdeogramV4TransparentResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateImageIdeogramV4TransparentResponse" /> class.
        /// </summary>
...
#endif
        public GenerateImageIdeogramV4TransparentResponse(
            string generationId,
            int seed,
