...
namespace Ideogram
{
    public partial class ImagesGenerateClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostGenerateImageV2NanoBananaProSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostGenerateImageV2NanoBananaProSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostGenerateImageV2NanoBananaProSecurityRequirement0,
            };
        partial void PreparePostGenerateImageV2NanoBananaProArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? dryRun,
            global::Ideogram.GenerateImageNanoBananaProRequest request);
        partial void PreparePostGenerateImageV2NanoBananaProRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? dryRun,
            global::Ideogram.GenerateImageNanoBananaProRequest request);
        partial void ProcessPostGenerateImageV2NanoBananaProResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostGenerateImageV2NanoBananaProResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Generate images with Nano Banana Pro, from a text prompt or by editing source images<br/>
        /// Generate one or more images with Nano Banana Pro. The prompt is<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.GenerateImageNanoBananaProResponse> PostGenerateImageV2NanoBananaProAsync(
        ...
        {
            var __response = await PostGenerateImageV2NanoBananaProAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.GenerateImageNanoBananaProResponse>> PostGenerateImageV2NanoBananaProAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostGenerateImageV2NanoBananaProArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostGenerateImageV2NanoBananaProSecurityRequirements,
                operationName: "PostGenerateImageV2NanoBananaProAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostGenerateImageV2NanoBananaProRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostGenerateImageV2NanoBananaPro",
                                methodName: "PostGenerateImageV2NanoBananaProAsync",
                                pathTemplate: "\"/v2/image/generate/nano-banana-pro\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostGenerateImageV2NanoBananaProResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostGenerateImageV2NanoBananaProResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.GenerateImageNanoBananaProResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.GenerateImageNanoBananaProResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.GenerateImageNanoBananaProResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.GenerateImageNanoBananaProResponse> PostGenerateImageV2NanoBananaProAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.GenerateImageNanoBananaProRequest
            {
                Prompt = prompt,
            ...
            return await PostGenerateImageV2NanoBananaProAsync(
                dryRun: dryRun,
                request: __request,
                requestOptions: requestOptions,
