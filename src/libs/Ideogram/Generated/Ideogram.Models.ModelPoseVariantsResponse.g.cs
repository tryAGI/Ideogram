...
{
    /// <summary>
    /// Acknowledgement that pose-variant generation was accepted. Poll<br/>
    ...
    public sealed partial class ModelPoseVariantsResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelPoseVariantsResponse" /> class.
        /// </summary>
...
#endif
        public ModelPoseVariantsResponse(
            string generationId)
        {
