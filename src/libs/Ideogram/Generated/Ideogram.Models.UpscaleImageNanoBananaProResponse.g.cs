...
{
    /// <summary>
    /// Response returned by `POST /v2/image/upscale/nano-banana-pro`.<br/>
    ...
    public sealed partial class UpscaleImageNanoBananaProResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpscaleImageNanoBananaProResponse" /> class.
        /// </summary>
...
#endif
        public UpscaleImageNanoBananaProResponse(
            string generationId,
            int seed,
            int width,
            int height,
