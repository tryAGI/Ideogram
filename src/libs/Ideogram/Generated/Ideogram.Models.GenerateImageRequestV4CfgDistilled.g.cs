...
{
    /// <summary>
    /// Request body for the CFG/guidance-distilled Ideogram 4.0 generate<br/>
    /// endpoint. Supply exactly one of `text_prompt` or `json_prompt`. The base<br/>
    /// model is always the CFG-distilled Ideogram 4.0; a custom registry model<br/>
    /// cannot be selected on this endpoint.
    /// </summary>
    public sealed partial class GenerateImageRequestV4CfgDistilled
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateImageRequestV4CfgDistilled" /> class.
        /// </summary>
...
#endif
        public GenerateImageRequestV4CfgDistilled(
            string? textPrompt,
