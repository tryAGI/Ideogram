...
namespace Ideogram
{
    public partial class ImagesRemixClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostRemixImageV2IdeogramV4SecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostRemixImageV2IdeogramV4SecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostRemixImageV2IdeogramV4SecurityRequirement0,
            };
        partial void PreparePostRemixImageV2IdeogramV4Arguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.RemixImageIdeogramV4Request request);
        partial void PreparePostRemixImageV2IdeogramV4Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.RemixImageIdeogramV4Request request);
        partial void ProcessPostRemixImageV2IdeogramV4Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostRemixImageV2IdeogramV4ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.RemixImageIdeogramV4Response> PostRemixImageV2IdeogramV4Async(

            global::Ideogram.RemixImageIdeogramV4Request request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostRemixImageV2IdeogramV4AsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.RemixImageIdeogramV4Response>> PostRemixImageV2IdeogramV4AsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostRemixImageV2IdeogramV4Arguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostRemixImageV2IdeogramV4SecurityRequirements,
                operationName: "PostRemixImageV2IdeogramV4Async");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Ideogram.PathBuilder(
                                path: "/v2/images/remix/ideogram-v4",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostRemixImageV2IdeogramV4Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostRemixImageV2IdeogramV4",
                                methodName: "PostRemixImageV2IdeogramV4Async",
                                pathTemplate: "\"/v2/images/remix/ideogram-v4\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostRemixImageV2IdeogramV4Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostRemixImageV2IdeogramV4ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.RemixImageIdeogramV4Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.RemixImageIdeogramV4Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.RemixImageIdeogramV4Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.RemixImageIdeogramV4Response> PostRemixImageV2IdeogramV4Async(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.RemixImageIdeogramV4Request
            {
                Prompt = prompt,
            ...
            return await PostRemixImageV2IdeogramV4Async(
                request: __request,
                requestOptions: requestOptions,
