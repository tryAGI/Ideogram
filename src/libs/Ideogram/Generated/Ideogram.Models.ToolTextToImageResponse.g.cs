...
{
    /// <summary>
    /// Response returned by `POST /v2/tool/text-to-image`. Synchronous<br/>
    ...
    public sealed partial class ToolTextToImageResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolTextToImageResponse" /> class.
        /// </summary>
...
#endif
        public ToolTextToImageResponse(
            string generationId,
            int seed,
