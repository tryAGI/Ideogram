...
namespace Ideogram
{
    public partial class MiniAppsClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_UnpublishMiniAppSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_UnpublishMiniAppSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_UnpublishMiniAppSecurityRequirement0,
            };
        partial void PrepareUnpublishMiniAppArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string slug);
        partial void PrepareUnpublishMiniAppRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string slug);
        partial void ProcessUnpublishMiniAppResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task UnpublishMiniAppAsync(
            string slug,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await UnpublishMiniAppAsResponseAsync(
                slug: slug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse> UnpublishMiniAppAsResponseAsync(
            string slug,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUnpublishMiniAppArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UnpublishMiniAppSecurityRequirements,
                operationName: "UnpublishMiniAppAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUnpublishMiniAppRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UnpublishMiniApp",
                                methodName: "UnpublishMiniAppAsync",
                                pathTemplate: "$\"/mini-apps/unpublish/{slug}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUnpublishMiniAppResponse(
                    httpClient: HttpClient,
