...
namespace Ideogram
{
    public partial class GenerateClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostTextToVideoSeedDance2SecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostTextToVideoSeedDance2SecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostTextToVideoSeedDance2SecurityRequirement0,
            };
        partial void PreparePostTextToVideoSeedDance2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? webhookUrl,
            global::Ideogram.TextToVideoRequestSeedDance2 request);
        partial void PreparePostTextToVideoSeedDance2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? webhookUrl,
            global::Ideogram.TextToVideoRequestSeedDance2 request);
        partial void ProcessPostTextToVideoSeedDance2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostTextToVideoSeedDance2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.VideoGenerationResponse> PostTextToVideoSeedDance2Async(
        ...
        {
            var __response = await PostTextToVideoSeedDance2AsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.VideoGenerationResponse>> PostTextToVideoSeedDance2AsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostTextToVideoSeedDance2Arguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostTextToVideoSeedDance2SecurityRequirements,
                operationName: "PostTextToVideoSeedDance2Async");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostTextToVideoSeedDance2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostTextToVideoSeedDance2",
                                methodName: "PostTextToVideoSeedDance2Async",
                                pathTemplate: "\"/v2/async/text-to-video/seed-dance-2.0\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostTextToVideoSeedDance2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostTextToVideoSeedDance2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.VideoGenerationResponse> PostTextToVideoSeedDance2Async(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.TextToVideoRequestSeedDance2
            {
                Prompt = prompt,
            ...
            return await PostTextToVideoSeedDance2Async(
                webhookUrl: webhookUrl,
                request: __request,
                requestOptions: requestOptions,
