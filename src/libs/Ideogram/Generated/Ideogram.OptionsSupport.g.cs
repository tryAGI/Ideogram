...
namespace Ideogram
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Ideogram.AutoSDKRetryOptions Retry { get; set; } = new global::Ideogram.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Ideogram.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Ideogram.IAutoSDKHook>();
        ...
        public global::Ideogram.AutoSDKClientOptions AddHook(
            global::Ideogram.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Ideogram.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Ideogram.AutoSDKClientOptions UseAuthorizationProvider(
            global::Ideogram.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Ideogram.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Ideogram.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Ideogram.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Ideogram.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Ideogram.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Ideogram.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Ideogram.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Ideogram.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Ideogram.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Ideogram.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Ideogram.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Ideogram.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Ideogram.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Ideogram.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Ideogram.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        internal static global::Ideogram.AutoSDKHookContext CreateHookContext(
            ...
            global::Ideogram.AutoSDKClientOptions clientOptions,
            global::Ideogram.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Ideogram.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Ideogram.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Ideogram.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Ideogram.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Ideogram.IAutoSDKHook, global::Ideogram.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Ideogram.AutoSDKHookContext context)
        {
