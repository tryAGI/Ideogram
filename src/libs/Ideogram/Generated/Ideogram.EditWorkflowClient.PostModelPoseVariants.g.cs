...
namespace Ideogram
{
    public partial class EditWorkflowClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostModelPoseVariantsSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostModelPoseVariantsSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostModelPoseVariantsSecurityRequirement0,
            };
        partial void PreparePostModelPoseVariantsArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.ModelPoseVariantsRequest request);
        partial void PreparePostModelPoseVariantsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.ModelPoseVariantsRequest request);
        partial void ProcessPostModelPoseVariantsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostModelPoseVariantsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.ModelPoseVariantsResponse> PostModelPoseVariantsAsync(

            global::Ideogram.ModelPoseVariantsRequest request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostModelPoseVariantsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.ModelPoseVariantsResponse>> PostModelPoseVariantsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostModelPoseVariantsArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostModelPoseVariantsSecurityRequirements,
                operationName: "PostModelPoseVariantsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Ideogram.PathBuilder(
                                path: "/v2/tool/model-pose-variants",
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.PoseReferenceAssetIdentifier != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.PoseReferenceAssetIdentifier.ToJson(JsonSerializerContext)),
                                    name: "\"pose_reference_asset_identifier\"");
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostModelPoseVariantsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostModelPoseVariants",
                                methodName: "PostModelPoseVariantsAsync",
                                pathTemplate: "\"/v2/tool/model-pose-variants\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostModelPoseVariantsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostModelPoseVariantsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.ModelPoseVariantsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.ModelPoseVariantsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.ModelPoseVariantsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.ModelPoseVariantsResponse> PostModelPoseVariantsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.ModelPoseVariantsRequest
            {
                SourceAssetIdentifier = sourceAssetIdentifier,
                SourceImage = sourceImage,
                SourceImagename = sourceImagename,
                PoseReferenceAssetIdentifier = poseReferenceAssetIdentifier,
            ...
            return await PostModelPoseVariantsAsync(
                request: __request,
                requestOptions: requestOptions,
