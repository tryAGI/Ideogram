...
namespace Ideogram
{
    public partial class EditWorkflowClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostModelSwapSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostModelSwapSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostModelSwapSecurityRequirement0,
            };
        partial void PreparePostModelSwapArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.ModelSwapRequest request);
        partial void PreparePostModelSwapRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.ModelSwapRequest request);
        partial void ProcessPostModelSwapResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostModelSwapResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.ModelSwapResponse> PostModelSwapAsync(

            global::Ideogram.ModelSwapRequest request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostModelSwapAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.ModelSwapResponse>> PostModelSwapAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostModelSwapSecurityRequirements,
                operationName: "PostModelSwapAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            __httpRequestContent.Add(
                                content: new global::System.Net.Http.StringContent($"[{string.Join(",", global::System.Linq.Enumerable.Select(request.ModelAssetIdentifiers, x => x.ToJson(JsonSerializerContext)))}]"),
                                name: "\"model_asset_identifiers\"");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostModelSwap",
                                methodName: "PostModelSwapAsync",
                                pathTemplate: "\"/v2/tool/model-swap\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostModelSwapResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.ModelSwapResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.ModelSwapResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.ModelSwapResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.ModelSwapResponse> PostModelSwapAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.ModelSwapRequest
            {
                SourceAssetIdentifier = sourceAssetIdentifier,
                SourceImage = sourceImage,
                SourceImagename = sourceImagename,
                ModelAssetIdentifiers = modelAssetIdentifiers,
            ...
            return await PostModelSwapAsync(
                request: __request,
                requestOptions: requestOptions,
