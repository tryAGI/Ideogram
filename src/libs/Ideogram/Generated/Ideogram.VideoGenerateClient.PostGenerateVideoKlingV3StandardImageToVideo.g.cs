...
namespace Ideogram
{
    public partial class VideoGenerateClient
    {


        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostGenerateVideoKlingV3StandardImageToVideoSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostGenerateVideoKlingV3StandardImageToVideoSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostGenerateVideoKlingV3StandardImageToVideoSecurityRequirement0,
            };
        partial void PreparePostGenerateVideoKlingV3StandardImageToVideoArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.GenerateVideoKlingV3StandardImageToVideoRequest request);
        partial void PreparePostGenerateVideoKlingV3StandardImageToVideoRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.GenerateVideoKlingV3StandardImageToVideoRequest request);
        partial void ProcessPostGenerateVideoKlingV3StandardImageToVideoResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostGenerateVideoKlingV3StandardImageToVideoResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Generate a video from a first frame with Kling v3 Standard, by asset id or by uploaded bytes<br/>
        /// Generate a video from a first-frame image and a text prompt with Kling<br/>
        /// v3 Standard. Supply the first frame either as an<br/>
        ...
        /// there is no aspect ratio to set.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.GenerateVideoKlingV3Response> PostGenerateVideoKlingV3StandardImageToVideoAsync(

            global::Ideogram.GenerateVideoKlingV3StandardImageToVideoRequest request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostGenerateVideoKlingV3StandardImageToVideoAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.GenerateVideoKlingV3Response>> PostGenerateVideoKlingV3StandardImageToVideoAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostGenerateVideoKlingV3StandardImageToVideoArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostGenerateVideoKlingV3StandardImageToVideoSecurityRequirements,
                operationName: "PostGenerateVideoKlingV3StandardImageToVideoAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Ideogram.PathBuilder(
                                path: "/v2/video/generate/kling-v3-standard-image-to-video",
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.EndImageAssetIdentifier != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.EndImageAssetIdentifier.ToJson(JsonSerializerContext)),
                                    name: "\"end_image_asset_identifier\"");

                            }
                            if (request.EndImage != default)
                            {

                                var __contentEndImage = new global::System.Net.Http.ByteArrayContent(request.EndImage ?? global::System.Array.Empty<byte>());
                                __contentEndImage.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.EndImagename is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.EndImagename) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                                ...
                                __httpRequestContent.Add(
                                    content: __contentEndImage,
                                    name: "\"end_image\"",
                                    fileName: request.EndImagename != null ? $"\"{request.EndImagename}\"" : string.Empty);
                                if (__contentEndImage.Headers.ContentDisposition != null)
                                {
                                    __contentEndImage.Headers.ContentDisposition.FileNameStar = null;
                                }
                            ...
                            if (request.GenerateAudio != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((global::System.Convert.ToString(request.GenerateAudio, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty).ToLowerInvariant()),
                                    name: "\"generate_audio\"");

                            }
                            if (request.ShotType != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((request.ShotType).HasValue ? (request.ShotType).GetValueOrDefault().ToValueString() : string.Empty),
                                    name: "\"shot_type\"");
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostGenerateVideoKlingV3StandardImageToVideoRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostGenerateVideoKlingV3StandardImageToVideo",
                                methodName: "PostGenerateVideoKlingV3StandardImageToVideoAsync",
                                pathTemplate: "\"/v2/video/generate/kling-v3-standard-image-to-video\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostGenerateVideoKlingV3StandardImageToVideoResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostGenerateVideoKlingV3StandardImageToVideoResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.GenerateVideoKlingV3Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.GenerateVideoKlingV3Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.GenerateVideoKlingV3Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.GenerateVideoKlingV3Response> PostGenerateVideoKlingV3StandardImageToVideoAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.GenerateVideoKlingV3StandardImageToVideoRequest
            {
                ImageAssetIdentifier = imageAssetIdentifier,
                Image = image,
                Imagename = imagename,
                EndImageAssetIdentifier = endImageAssetIdentifier,
                EndImage = endImage,
            ...
            return await PostGenerateVideoKlingV3StandardImageToVideoAsync(
                request: __request,
                requestOptions: requestOptions,
