...
namespace Ideogram
{
    public partial class WebhooksClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_GetWebhookSigningJwksSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_GetWebhookSigningJwksSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_GetWebhookSigningJwksSecurityRequirement0,
            };
        partial void PrepareGetWebhookSigningJwksArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetWebhookSigningJwksRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetWebhookSigningJwksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWebhookSigningJwksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.WebhookSigningJwks> GetWebhookSigningJwksAsync(
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetWebhookSigningJwksAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.WebhookSigningJwks>> GetWebhookSigningJwksAsResponseAsync(
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetWebhookSigningJwksArguments(
                httpClient: HttpClient);


            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetWebhookSigningJwksSecurityRequirements,
                operationName: "GetWebhookSigningJwksAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetWebhookSigningJwksRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetWebhookSigningJwks",
                                methodName: "GetWebhookSigningJwksAsync",
                                pathTemplate: "\"/v1/.well-known/jwks.json\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWebhookSigningJwksResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetWebhookSigningJwksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.WebhookSigningJwks.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.WebhookSigningJwks>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.WebhookSigningJwks.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
