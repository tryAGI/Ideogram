...
{
    /// <summary>
    /// Request body for the FLUX.2-Klein generate endpoint. The base model is<br/>
    ...
    public sealed partial class GenerateImageRequestFlux2Klein
    {
        ...
        /// </summary>
        /// <example>model/my-flux-klein-lora/version/0</example>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateImageRequestFlux2Klein" /> class.
        /// </summary>
        /// <param name="prompt">
        /// A natural-language prompt for image generation.<br/>
        /// Example: A photo of a tabby cat sleeping on a couch, soft daylight.
...
#endif
        public GenerateImageRequestFlux2Klein(
            string prompt,
            string? systemPrompt,
            int? width,
            int? height,
