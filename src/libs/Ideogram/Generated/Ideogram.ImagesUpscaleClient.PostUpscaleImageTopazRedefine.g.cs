...
namespace Ideogram
{
    public partial class ImagesUpscaleClient
    {


        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostUpscaleImageTopazRedefineSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostUpscaleImageTopazRedefineSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostUpscaleImageTopazRedefineSecurityRequirement0,
            };
        partial void PreparePostUpscaleImageTopazRedefineArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? dryRun,
            global::Ideogram.UpscaleImageTopazRedefineRequest request);
        partial void PreparePostUpscaleImageTopazRedefineRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? dryRun,
            global::Ideogram.UpscaleImageTopazRedefineRequest request);
        partial void ProcessPostUpscaleImageTopazRedefineResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostUpscaleImageTopazRedefineResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.UpscaleImageTopazRedefineResponse> PostUpscaleImageTopazRedefineAsync(
        ...
        {
            var __response = await PostUpscaleImageTopazRedefineAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.UpscaleImageTopazRedefineResponse>> PostUpscaleImageTopazRedefineAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostUpscaleImageTopazRedefineArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostUpscaleImageTopazRedefineSecurityRequirements,
                operationName: "PostUpscaleImageTopazRedefineAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.Autoprompt != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((global::System.Convert.ToString(request.Autoprompt, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty).ToLowerInvariant()),
                                    name: "\"autoprompt\"");

                            }
                            if (request.Texture != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(global::System.Convert.ToString(request.Texture, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty),
                                    name: "\"texture\"");

                            }
                            if (request.Detail != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((global::System.Convert.ToString(request.Detail, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty).ToLowerInvariant()),
                                    name: "\"detail\"");

                            }
                            if (request.DetailStrength != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(global::System.Convert.ToString(request.DetailStrength, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty),
                                    name: "\"detail_strength\"");

                            }
                            if (request.Sharpen != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(global::System.Convert.ToString(request.Sharpen, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty),
                                    name: "\"sharpen\"");

                            }
                            if (request.Denoise != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(global::System.Convert.ToString(request.Denoise, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty),
                                    name: "\"denoise\"");

                            }
                            if (request.FaceEnhancement != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((global::System.Convert.ToString(request.FaceEnhancement, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty).ToLowerInvariant()),
                                    name: "\"face_enhancement\"");

                            }
                            if (request.FaceEnhancementStrength != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(global::System.Convert.ToString(request.FaceEnhancementStrength, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty),
                                    name: "\"face_enhancement_strength\"");

                            }
                            if (request.FaceEnhancementCreativity != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(global::System.Convert.ToString(request.FaceEnhancementCreativity, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty),
                                    name: "\"face_enhancement_creativity\"");

                            }
                            if (request.SubjectDetection != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent((request.SubjectDetection).HasValue ? (request.SubjectDetection).GetValueOrDefault().ToValueString() : string.Empty),
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostUpscaleImageTopazRedefineRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostUpscaleImageTopazRedefine",
                                methodName: "PostUpscaleImageTopazRedefineAsync",
                                pathTemplate: "\"/v2/image/upscale/topaz-redefine\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostUpscaleImageTopazRedefineResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostUpscaleImageTopazRedefineResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.UpscaleImageTopazRedefineResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.UpscaleImageTopazRedefineResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.UpscaleImageTopazRedefineResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.UpscaleImageTopazRedefineResponse> PostUpscaleImageTopazRedefineAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.UpscaleImageTopazRedefineRequest
            {
            ...
            return await PostUpscaleImageTopazRedefineAsync(
                dryRun: dryRun,
                request: __request,
                requestOptions: requestOptions,
