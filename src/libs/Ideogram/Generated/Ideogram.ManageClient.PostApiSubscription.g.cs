            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                else
                {
                    ...
                    __value_400 = await global::Ideogram.PostApiSubscriptionError.FromJsonStreamAsync(__contentStream_400, JsonSerializerContext).ConfigureAwait(false);
                }
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::Ideogram.PostApiSubscriptionResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                ...
                var __responseValue = await global::Ideogram.PostApiSubscriptionResponse.FromJsonStreamAsync(__responseStream, JsonSerializerContext).ConfigureAwait(false);
