...
namespace Ideogram
{
    public partial class GenerateClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.ImageGenerationResponseV3>> PostTryOnV3AsResponseAsync(
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            __contentProductReferenceImages.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue("application/octet-stream");
                                __httpRequestContent.Add(
        ...
        /// </summary>
        /// <param name="image">
        /// The image containing a person wearing clothing to be modified (max size 25MB); only JPEG, WebP and PNG formats are supported at this time.
        /// </param>
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Ideogram.TryOnRequestV3
            {
                ...
                StyleType = styleType,
                StylePreset = stylePreset,
                ProductReferenceImages = new global::System.Collections.Generic.List<byte[]>(),
            };
            PrepareArguments(
                client: HttpClient);
            PreparePostTryOnV3Arguments(
