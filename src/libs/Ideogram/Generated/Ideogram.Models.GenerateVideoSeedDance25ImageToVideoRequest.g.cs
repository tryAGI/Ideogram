...
{
    /// <summary>
    /// Request body for Seedance 2.5 image-to-video generation. Supply the<br/>
    ...
    public sealed partial class GenerateVideoSeedDance25ImageToVideoRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateVideoSeedDance25ImageToVideoRequest" /> class.
        /// </summary>
        /// <param name="prompt">
        /// A natural-language prompt describing how the first frame should animate.<br/>
        /// Example: The camera slowly pans right as the waves roll in.
...
#endif
        public GenerateVideoSeedDance25ImageToVideoRequest(
            string prompt,
