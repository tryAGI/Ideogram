...
{
    /// <summary>
    /// Response returned by `POST /v2/image/upscale/gemini-3-pro`.<br/>
    ...
    public sealed partial class UpscaleImageGemini3ProResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpscaleImageGemini3ProResponse" /> class.
        /// </summary>
...
#endif
        public UpscaleImageGemini3ProResponse(
            string generationId,
            int seed,
            int width,
            int height,
