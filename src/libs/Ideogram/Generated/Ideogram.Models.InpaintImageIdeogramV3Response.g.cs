...
{
    /// <summary>
    /// Response returned by `POST /v2/images/inpaint/ideogram-v3`.<br/>
    ...
    public sealed partial class InpaintImageIdeogramV3Response
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InpaintImageIdeogramV3Response" /> class.
        /// </summary>
...
#endif
        public InpaintImageIdeogramV3Response(
            string generationId,
            int seed,
            int width,
            int height,
