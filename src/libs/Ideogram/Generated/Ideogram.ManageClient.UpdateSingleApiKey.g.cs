...
namespace Ideogram
{
    public partial class ManageClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_UpdateSingleApiKeySecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_UpdateSingleApiKeySecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_UpdateSingleApiKeySecurityRequirement0,
            };
        partial void PrepareUpdateSingleApiKeyArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string apiKeyId,
            global::Ideogram.PatchApiKeyRequest request);
        partial void PrepareUpdateSingleApiKeyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string apiKeyId,
            global::Ideogram.PatchApiKeyRequest request);
        partial void ProcessUpdateSingleApiKeyResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateSingleApiKeyResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.ApiProfileApiKey> UpdateSingleApiKeyAsync(
            string apiKeyId,
        ...
        {
            var __response = await UpdateSingleApiKeyAsResponseAsync(
                apiKeyId: apiKeyId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.ApiProfileApiKey>> UpdateSingleApiKeyAsResponseAsync(
            string apiKeyId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateSingleApiKeyArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateSingleApiKeySecurityRequirements,
                operationName: "UpdateSingleApiKeyAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateSingleApiKeyRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateSingleApiKey",
                                methodName: "UpdateSingleApiKeyAsync",
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateSingleApiKeyResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.ApiProfileApiKey.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.ApiProfileApiKey>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.ApiProfileApiKey.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.ApiProfileApiKey> UpdateSingleApiKeyAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.PatchApiKeyRequest
            {
                Label = label,
            };

            return await UpdateSingleApiKeyAsync(
                apiKeyId: apiKeyId,
                request: __request,
                requestOptions: requestOptions,
