...
{
    /// <summary>
    /// Request body for the Z-Image generate endpoint. The base model is<br/>
    /// pinned server-side; supply `custom_model_uri` to layer a registered<br/>
    /// Z-Image LoRA finetune on the base.<br/>
    ...
    public sealed partial class GenerateImageRequestZImage
    {
        ...
        /// </summary>
        /// <example>model/my-z-image-lora/version/0</example>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateImageRequestZImage" /> class.
        /// </summary>
        /// <param name="prompt">
        /// A natural-language prompt for image generation.<br/>
        /// Example: A futuristic cityscape at golden hour, highly detailed.
...
#endif
        public GenerateImageRequestZImage(
            string prompt,
            string? systemPrompt,
            int? width,
            int? height,
