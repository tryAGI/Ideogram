...
namespace Ideogram
{
    public partial class GenerateClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostGenerateImageFlux2KleinAsyncSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostGenerateImageFlux2KleinAsyncSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostGenerateImageFlux2KleinAsyncSecurityRequirement0,
            };
        partial void PreparePostGenerateImageFlux2KleinAsyncArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string webhookUrl,
            global::Ideogram.GenerateImageRequestFlux2Klein request);
        partial void PreparePostGenerateImageFlux2KleinAsyncRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string webhookUrl,
            global::Ideogram.GenerateImageRequestFlux2Klein request);
        partial void ProcessPostGenerateImageFlux2KleinAsyncResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostGenerateImageFlux2KleinAsyncResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Generate with FLUX.2-Klein asynchronously via webhook<br/>
        /// Accepts a FLUX.2-Klein generation request for asynchronous processing and<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.AsyncImageGenerationResponseV4> PostGenerateImageFlux2KleinAsyncAsync(
            string webhookUrl,
        ...
        {
            var __response = await PostGenerateImageFlux2KleinAsyncAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.AsyncImageGenerationResponseV4>> PostGenerateImageFlux2KleinAsyncAsResponseAsync(
            string webhookUrl,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostGenerateImageFlux2KleinAsyncArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostGenerateImageFlux2KleinAsyncSecurityRequirements,
                operationName: "PostGenerateImageFlux2KleinAsyncAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Ideogram.PathBuilder(
                                path: "/v1/flux-2-klein/async/generate",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostGenerateImageFlux2KleinAsyncRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostGenerateImageFlux2KleinAsync",
                                methodName: "PostGenerateImageFlux2KleinAsyncAsync",
                                pathTemplate: "\"/v1/flux-2-klein/async/generate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostGenerateImageFlux2KleinAsyncResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostGenerateImageFlux2KleinAsyncResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PostGenerateImageFlux2KleinAsyncAsync(
                webhookUrl: webhookUrl,
                request: __request,
                requestOptions: requestOptions,
