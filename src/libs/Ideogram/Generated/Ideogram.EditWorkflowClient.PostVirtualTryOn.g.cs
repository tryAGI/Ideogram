...
namespace Ideogram
{
    public partial class EditWorkflowClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostVirtualTryOnSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostVirtualTryOnSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostVirtualTryOnSecurityRequirement0,
            };
        partial void PreparePostVirtualTryOnArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.VirtualTryOnRequest request);
        partial void PreparePostVirtualTryOnRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.VirtualTryOnRequest request);
        partial void ProcessPostVirtualTryOnResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostVirtualTryOnResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.VirtualTryOnResponse> PostVirtualTryOnAsync(

            global::Ideogram.VirtualTryOnRequest request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostVirtualTryOnAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.VirtualTryOnResponse>> PostVirtualTryOnAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostVirtualTryOnArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostVirtualTryOnSecurityRequirements,
                operationName: "PostVirtualTryOnAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.PersonAssetIdentifier != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.PersonAssetIdentifier.ToJson(JsonSerializerContext)),
                                    name: "\"person_asset_identifier\"");

                            }
                            if (request.PersonImage != default)
                            {

                                var __contentPersonImage = new global::System.Net.Http.ByteArrayContent(request.PersonImage ?? global::System.Array.Empty<byte>());
                                __contentPersonImage.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.PersonImagename is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.PersonImagename) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                                ...
                                __httpRequestContent.Add(
                                    content: __contentPersonImage,
                                    name: "\"person_image\"",
                                    fileName: request.PersonImagename != null ? $"\"{request.PersonImagename}\"" : string.Empty);
                                if (__contentPersonImage.Headers.ContentDisposition != null)
                                {
                                    __contentPersonImage.Headers.ContentDisposition.FileNameStar = null;
                                }
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostVirtualTryOnRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostVirtualTryOn",
                                methodName: "PostVirtualTryOnAsync",
                                pathTemplate: "\"/v2/workflow/virtual-try-on\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostVirtualTryOnResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostVirtualTryOnResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.VirtualTryOnResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.VirtualTryOnResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.VirtualTryOnResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.VirtualTryOnResponse> PostVirtualTryOnAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.VirtualTryOnRequest
            {
                PersonAssetIdentifier = personAssetIdentifier,
            ...
            return await PostVirtualTryOnAsync(
                request: __request,
                requestOptions: requestOptions,
