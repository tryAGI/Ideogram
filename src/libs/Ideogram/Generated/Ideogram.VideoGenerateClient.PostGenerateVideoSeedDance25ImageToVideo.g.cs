...
namespace Ideogram
{
    public partial class VideoGenerateClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostGenerateVideoSeedDance25ImageToVideoSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostGenerateVideoSeedDance25ImageToVideoSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostGenerateVideoSeedDance25ImageToVideoSecurityRequirement0,
            };
        partial void PreparePostGenerateVideoSeedDance25ImageToVideoArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.GenerateVideoSeedDance25ImageToVideoRequest request);
        partial void PreparePostGenerateVideoSeedDance25ImageToVideoRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.GenerateVideoSeedDance25ImageToVideoRequest request);
        partial void ProcessPostGenerateVideoSeedDance25ImageToVideoResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostGenerateVideoSeedDance25ImageToVideoResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Generate a video from a first frame with Seedance 2.5, by asset id or by uploaded bytes<br/>
        /// Generate a video from a first-frame image and a text prompt with<br/>
        /// Seedance 2.5. Supply the first frame either as an<br/>
        ...
        /// Seedance 2.5 always derives an image-to-video result's aspect ratio<br/>
        /// from its first frame, so this endpoint takes no `aspect_ratio`.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.GenerateVideoSeedDance25Response> PostGenerateVideoSeedDance25ImageToVideoAsync(

            global::Ideogram.GenerateVideoSeedDance25ImageToVideoRequest request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostGenerateVideoSeedDance25ImageToVideoAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.GenerateVideoSeedDance25Response>> PostGenerateVideoSeedDance25ImageToVideoAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostGenerateVideoSeedDance25ImageToVideoArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostGenerateVideoSeedDance25ImageToVideoSecurityRequirements,
                operationName: "PostGenerateVideoSeedDance25ImageToVideoAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostGenerateVideoSeedDance25ImageToVideoRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostGenerateVideoSeedDance25ImageToVideo",
                                methodName: "PostGenerateVideoSeedDance25ImageToVideoAsync",
                                pathTemplate: "\"/v2/video/generate/seedance-2-5-image-to-video\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostGenerateVideoSeedDance25ImageToVideoResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostGenerateVideoSeedDance25ImageToVideoResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.GenerateVideoSeedDance25Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.GenerateVideoSeedDance25Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.GenerateVideoSeedDance25Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.GenerateVideoSeedDance25Response> PostGenerateVideoSeedDance25ImageToVideoAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.GenerateVideoSeedDance25ImageToVideoRequest
            {
            ...
            return await PostGenerateVideoSeedDance25ImageToVideoAsync(
                request: __request,
                requestOptions: requestOptions,
