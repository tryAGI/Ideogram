...
namespace Ideogram
{
    public partial class GenerateClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostRemixImageV4AsyncSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostRemixImageV4AsyncSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostRemixImageV4AsyncSecurityRequirement0,
            };
        partial void PreparePostRemixImageV4AsyncArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? webhookUrl,
            global::Ideogram.RemixImageRequestV4 request);
        partial void PreparePostRemixImageV4AsyncRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? webhookUrl,
            global::Ideogram.RemixImageRequestV4 request);
        partial void ProcessPostRemixImageV4AsyncResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostRemixImageV4AsyncResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.AsyncImageGenerationResponseV4> PostRemixImageV4AsyncAsync(
        ...
        {
            var __response = await PostRemixImageV4AsyncAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.AsyncImageGenerationResponseV4>> PostRemixImageV4AsyncAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostRemixImageV4AsyncArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostRemixImageV4AsyncSecurityRequirements,
                operationName: "PostRemixImageV4AsyncAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostRemixImageV4AsyncRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostRemixImageV4Async",
                                methodName: "PostRemixImageV4AsyncAsync",
                                pathTemplate: "\"/v1/ideogram-v4/async/remix\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostRemixImageV4AsyncResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostRemixImageV4AsyncResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.AsyncImageGenerationResponseV4> PostRemixImageV4AsyncAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.RemixImageRequestV4
            {
                Image = image,
                Imagename = imagename,
            ...
            return await PostRemixImageV4AsyncAsync(
                webhookUrl: webhookUrl,
                request: __request,
                requestOptions: requestOptions,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Ideogram.RemixImageRequestV4
            {
