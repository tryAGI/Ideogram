...
namespace Ideogram
{
    ...
    public enum ModelVersion
    {
        ...
        V40,
        /// <summary>
        /// Model 4.0 Layered Design (vector-text path; gated by the access_to_v4_experimental feature flag)
        /// </summary>
        V4d,
        /// <summary>
        /// Model 4.0 Layout to Image (HTML layout rasterized as IMAGE_TO_IMAGE conditioning; gated by the access_to_v4_experimental feature flag)
        /// </summary>
        V4Layout2image,
    }
