...
namespace Ideogram
{
    public partial class ImagesEditClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostEditImageGemini31FlashSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostEditImageGemini31FlashSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostEditImageGemini31FlashSecurityRequirement0,
            };
        partial void PreparePostEditImageGemini31FlashArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.EditImageGemini31FlashRequest request);
        partial void PreparePostEditImageGemini31FlashRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.EditImageGemini31FlashRequest request);
        partial void ProcessPostEditImageGemini31FlashResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostEditImageGemini31FlashResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.EditImageGemini31FlashResponse> PostEditImageGemini31FlashAsync(

            global::Ideogram.EditImageGemini31FlashRequest request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostEditImageGemini31FlashAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.EditImageGemini31FlashResponse>> PostEditImageGemini31FlashAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostEditImageGemini31FlashArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostEditImageGemini31FlashSecurityRequirements,
                operationName: "PostEditImageGemini31FlashAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Ideogram.PathBuilder(
                                path: "/v2/images/edit/gemini-3.1-flash",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostEditImageGemini31FlashRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostEditImageGemini31Flash",
                                methodName: "PostEditImageGemini31FlashAsync",
                                pathTemplate: "\"/v2/images/edit/gemini-3.1-flash\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostEditImageGemini31FlashResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostEditImageGemini31FlashResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.EditImageGemini31FlashResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.EditImageGemini31FlashResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.EditImageGemini31FlashResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.EditImageGemini31FlashResponse> PostEditImageGemini31FlashAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.EditImageGemini31FlashRequest
            {
                Prompt = prompt,
            ...
            return await PostEditImageGemini31FlashAsync(
                request: __request,
                requestOptions: requestOptions,
