...
namespace Ideogram
{
    public partial class ImagesInpaintClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostInpaintImageV2IdeogramV3SecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostInpaintImageV2IdeogramV3SecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostInpaintImageV2IdeogramV3SecurityRequirement0,
            };
        ...
        partial void ProcessPostInpaintImageV2IdeogramV3ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostInpaintImageV2IdeogramV3SecurityRequirements,
                operationName: "PostInpaintImageV2IdeogramV3Async");
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostInpaintImageV2IdeogramV3Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostInpaintImageV2IdeogramV3ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.InpaintImageIdeogramV3Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.InpaintImageIdeogramV3Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.InpaintImageIdeogramV3Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.InpaintImageIdeogramV3Response> PostInpaintImageV2IdeogramV3Async(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.InpaintImageIdeogramV3Request
            {
                Prompt = prompt,
