...
namespace Ideogram
{
    public partial class GenerateClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostGenerateImageZImageAsyncSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostGenerateImageZImageAsyncSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostGenerateImageZImageAsyncSecurityRequirement0,
            };
        partial void PreparePostGenerateImageZImageAsyncArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string webhookUrl,
            global::Ideogram.GenerateImageRequestZImage request);
        partial void PreparePostGenerateImageZImageAsyncRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string webhookUrl,
            global::Ideogram.GenerateImageRequestZImage request);
        partial void ProcessPostGenerateImageZImageAsyncResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostGenerateImageZImageAsyncResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Generate with Z-Image asynchronously via webhook<br/>
        /// Accepts a Z-Image generation request for asynchronous processing and<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.AsyncImageGenerationResponseV4> PostGenerateImageZImageAsyncAsync(
            string webhookUrl,
        ...
        {
            var __response = await PostGenerateImageZImageAsyncAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.AsyncImageGenerationResponseV4>> PostGenerateImageZImageAsyncAsResponseAsync(
            string webhookUrl,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostGenerateImageZImageAsyncArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostGenerateImageZImageAsyncSecurityRequirements,
                operationName: "PostGenerateImageZImageAsyncAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Ideogram.PathBuilder(
                                path: "/v1/z-image/async/generate",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostGenerateImageZImageAsyncRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostGenerateImageZImageAsync",
                                methodName: "PostGenerateImageZImageAsyncAsync",
                                pathTemplate: "\"/v1/z-image/async/generate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostGenerateImageZImageAsyncResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostGenerateImageZImageAsyncResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PostGenerateImageZImageAsyncAsync(
                webhookUrl: webhookUrl,
                request: __request,
                requestOptions: requestOptions,
