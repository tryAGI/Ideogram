...
namespace Ideogram
{
    public partial class GenerateClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostGenerateImagePImageMediumSecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostGenerateImagePImageMediumSecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostGenerateImagePImageMediumSecurityRequirement0,
            };
        partial void PreparePostGenerateImagePImageMediumArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Ideogram.GenerateImageRequestPImage request);
        partial void PreparePostGenerateImagePImageMediumRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Ideogram.GenerateImageRequestPImage request);
        partial void ProcessPostGenerateImagePImageMediumResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostGenerateImagePImageMediumResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Generate with the distilled few-step Ideogram model (medium speed tier)<br/>
        /// Generates images synchronously using the distilled few-step Ideogram<br/>
        /// model at the medium speed tier — the balanced default of speed, cost, and<br/>
        /// quality. The speed tier controls the number of diffusion steps and the<br/>
        /// per-image price.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.ImageGenerationResponseV4> PostGenerateImagePImageMediumAsync(

            global::Ideogram.GenerateImageRequestPImage request,
            global::Ideogram.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostGenerateImagePImageMediumAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.ImageGenerationResponseV4>> PostGenerateImagePImageMediumAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostGenerateImagePImageMediumArguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostGenerateImagePImageMediumSecurityRequirements,
                operationName: "PostGenerateImagePImageMediumAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostGenerateImagePImageMediumRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostGenerateImagePImageMedium",
                                methodName: "PostGenerateImagePImageMediumAsync",
                                pathTemplate: "\"/v1/p-image-ideogram/medium/generate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostGenerateImagePImageMediumResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostGenerateImagePImageMediumResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PostGenerateImagePImageMediumAsync(
                request: __request,
                requestOptions: requestOptions,
