...
namespace Ideogram
{
    public partial class GenerateClient
    {
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement s_PostImageToVideoSeedDance2SecurityRequirement0 =
        ...
        private static readonly global::Ideogram.EndPointSecurityRequirement[] s_PostImageToVideoSeedDance2SecurityRequirements =
            new global::Ideogram.EndPointSecurityRequirement[]
            {                s_PostImageToVideoSeedDance2SecurityRequirement0,
            };
        partial void PreparePostImageToVideoSeedDance2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? webhookUrl,
            global::Ideogram.ImageToVideoRequestSeedDance2 request);
        partial void PreparePostImageToVideoSeedDance2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? webhookUrl,
            global::Ideogram.ImageToVideoRequestSeedDance2 request);
        partial void ProcessPostImageToVideoSeedDance2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostImageToVideoSeedDance2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.VideoGenerationResponse> PostImageToVideoSeedDance2Async(
        ...
        {
            var __response = await PostImageToVideoSeedDance2AsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Ideogram.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Ideogram.AutoSDKHttpResponse<global::Ideogram.VideoGenerationResponse>> PostImageToVideoSeedDance2AsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostImageToVideoSeedDance2Arguments(
            ...
            var __authorizations = global::Ideogram.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostImageToVideoSeedDance2SecurityRequirements,
                operationName: "PostImageToVideoSeedDance2Async");
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (request.ImageAssetId != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.ImageAssetId.ToJson(JsonSerializerContext)),
                                    name: "\"image_asset_id\"");
                            ...
                            if (request.NumVideos != default)
                            {

                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(global::System.Convert.ToString(request.NumVideos, global::System.Globalization.CultureInfo.InvariantCulture) ?? string.Empty),
                                    name: "\"num_videos\"");
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostImageToVideoSeedDance2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Ideogram.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PostImageToVideoSeedDance2",
                                methodName: "PostImageToVideoSeedDance2Async",
                                pathTemplate: "\"/v2/async/image-to-video/seed-dance-2.0\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostImageToVideoSeedDance2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Ideogram.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostImageToVideoSeedDance2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Ideogram.VideoGenerationResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Ideogram.AutoSDKHttpResponse<global::Ideogram.VideoGenerationResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Ideogram.VideoGenerationResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Ideogram.VideoGenerationResponse> PostImageToVideoSeedDance2Async(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Ideogram.ImageToVideoRequestSeedDance2
            {
                Image = image,
                Imagename = imagename,
            ...
            return await PostImageToVideoSeedDance2Async(
                webhookUrl: webhookUrl,
                request: __request,
                requestOptions: requestOptions,
