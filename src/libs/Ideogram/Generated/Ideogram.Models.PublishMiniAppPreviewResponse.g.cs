...
{
    /// <summary>
    /// Confirmation of a published mini-app preview entry.<br/>
    ...
    public sealed partial class PublishMiniAppPreviewResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PublishMiniAppPreviewResponse" /> class.
        /// </summary>
...
#endif
        public PublishMiniAppPreviewResponse(
            string previewId)
        {
