...
{
    /// <summary>
    /// Response returned by `POST /v2/images/edit/ideogram-4.5`. Synchronous<br/>
    /// requests (the default) include the output image in `data`. Requests<br/>
    ...
    public sealed partial class EditImageIdeogram45Response
    {
        ...
        /// <summary>
        /// The output images, in generation order. Present only for synchronous requests (`async` omitted or false).
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EditImageIdeogram45Response" /> class.
        /// </summary>
...
#endif
        public EditImageIdeogram45Response(
            string generationId,
            int seed,
            int width,
            int height,
