...
namespace Ideogram
{
    ...
    {
        /// <summary>
        /// The direct link to the edited image. Empty when the image fails safety checks.<br/>
        ...
        /// <summary>
        /// Whether the edited image passes safety checks. If false, the url field will be empty.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveObjectImageObject" /> class.
        /// </summary>
...
#endif
        public RemoveObjectImageObject(
            bool isImageSafe,
            string? url)
        {
            this.Url = url;
